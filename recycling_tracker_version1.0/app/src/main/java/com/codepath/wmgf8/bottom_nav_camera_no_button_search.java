...
public class bottom_nav_camera_no_button_search extends AppCompatActivity {
    private bottom_nav_camera_no_button_adapter adapter;
    //search function
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new bottom_nav_camera_no_button_adapter(this, exampleList);
