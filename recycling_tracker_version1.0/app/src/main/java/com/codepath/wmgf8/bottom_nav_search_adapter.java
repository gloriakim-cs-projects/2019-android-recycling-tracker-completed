...
public class bottom_nav_search_adapter extends BaseAdapter implements Filterable {
    private Context context;
    private LayoutInflater inflater;
    private List<ExampleItem> exampleList;
    private List<ExampleItem> exampleListFull;

    public bottom_nav_search_adapter(Context c, List<ExampleItem> exampleList) {
        context = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context,bottom_nav_search_details.class);
