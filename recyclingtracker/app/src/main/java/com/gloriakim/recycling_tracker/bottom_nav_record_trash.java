...
public class bottom_nav_record_trash extends AppCompatActivity {
    ...
    //all items
    GridView gridView;
    String[] trash_label = new String[75];
    int num = 0;
    String[] trash_num = new String[75];
    int[] trash_image = new int[75];

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bottom_nav_record_trash);

        total_collected = (TextView) findViewById(R.id.total_line);

        SharedPreferences settings = getSharedPreferences("PREFS", 0);
        int total_life_counter = settings.getInt("total_trash_counter", 0);

        total_collected.setText("Collected " + total_life_counter);
        ...
        for (int i = 0; i < oic_array.length; i++) {
            if (oic_array[i].equals("Styrofoam") || oic_array[i].equals("Styrofoam Box") || oic_array[i].equals("Tissue") || oic_array[i].equals("To Go Box") || oic_array[i].equals("Toothbrush") || oic_array[i].equals("Toothpaste") || oic_array[i].equals("Straw") || oic_array[i].equals("Pizza Box")) {
                ...
                trash_num[num] = Integer.toString(total_each_item_collected[i]);
                ...
                trash_image[num] = getResources().getIdentifier("com.gloriakim.recycling_tracker:drawable/" + s6, null, null);

                //move to next position
                num += 1;
            } else {
                //do nothing; this is for the recycle part
            }
        }
        //apply the max
        ...
        if (max_image > 0)
        {
            ...
            top1_image.setImageResource(trash_image[max_image]);
        }

        //display other items
        gridView = (GridView) findViewById(R.id.grid_view_recycle);
        bottom_nav_record_trash_adapter adapter = new bottom_nav_record_trash_adapter(this, trash_num, trash_image, num);
        ...
        ic_camera_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(bottom_nav_record_trash.this, bottom_nav_camera.class);
                startActivity(int1);
            }
        });
        ...
        ic_search_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int2 = new Intent(bottom_nav_record_trash.this, bottom_nav_search.class);
                startActivity(int2);
            }
        });
        ...
        ic_record_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int3 = new Intent(bottom_nav_record_trash.this, credits.class);
                startActivity(int3);
            }
        });
        ...
        ic_today_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int4 = new Intent(bottom_nav_record_trash.this, MainActivity.class);
                startActivity(int4);
            }
        });
        ...
        ic_goal_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int5 = new Intent(bottom_nav_record_trash.this, top_nav_goal.class);
                startActivity(int5);
            }
        });
        ...
        ic_collection_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int6 = new Intent(bottom_nav_record_trash.this, bottom_nav_record.class);
                startActivity(int6);
            }
        });
    }
