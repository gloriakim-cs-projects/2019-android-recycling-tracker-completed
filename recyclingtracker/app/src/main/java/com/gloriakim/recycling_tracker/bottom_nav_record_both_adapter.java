...
public class bottom_nav_record_both_adapter extends BaseAdapter {
    ...
    public bottom_nav_record_both_adapter(Context c, String[] numberWord, int[] numberImage, int recycle_num) {
        context = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.activity_bottom_nav_record_both_items, null);
        }
